...
const HowItWorks = () => {
    ...
    return (
        <section id="howitworks" className='bg-secondary-700 py-4 lg:py-14 xl:py-20'>
            ...
            <div className='bg-secondary-700 px-4 py-10 lg:py-14 py-20'>
            ...
            <div className='  py-4 max-w-[1200px] mt-8 sm:mt-16  lg:mt-16  2xl:max-w-[1440px] mx-auto px-4'>
                ...
                <div className='md:grid md:grid-cols-2   hidden justify-center items-center md:gap-20 mt-8 md:mt-0 max-w mx-auto '>
                    ...
                    <motion.div
                        ...
                        whileInView={{ opacity: 1, x: 0 }}
                        transition={{ duration: 0.6, delay: 0.4 }}
                        className='py-2  h-full max-h-[450px]  rounded-[12px]'>
                        <Image
                            src={WorkTwoRight}
                            alt="title"
                            width={588}
                    ...
                    <div className=' max-h-[500px]  space-y-4 '>
                        ...
                        <motion.div
                            ...
                            whileInView={{ opacity: 1, x: 0 }}
                            transition={{ duration: 0.6, delay: 0.4 }}
                            className='p-2 w-full flex flex-col justify-center items-start gap-4 '>
