        ...
        <section className='bg-secondary-700 py-20'>
            ...
            <div className='bg-secondary-700 px-4 '>
                ...
                <div className='mt-4 md:mt-8     max-w-[1200px] 2xl:max-w-[1440px] mx-auto py-8 md:p-10 lg:p-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 gap-6 md:gap-10 lg:gap-16 xl:gap-20 '>
                    ...
                    transition={{ duration: 0.6, delay: 0.4 }}
                    className='w-full  mx-auto rounded-[10.16px]'>
                        <Card
                            variant='testimonial'
                    ...
                    className='w-full  mx-auto md:col-span-2 lg:col-span-2 xl:col-span-1 rounded-[10.16px]'>
                        <Card
                            variant='testimonial'
                ...
                <div className=' hidden lg:flex gap-6 lg:justify-center lg:items-center  max-w-5xl mx-auto border-secondary-600'>
                    ...
                    className='h-[48px] w-[48px]  hover:h-[50px] hover:w-[50px] bg-secondary-400/10 hover:bg-primary  transition-all duration-300 hover:shadow-primary-600 hover:shadow-md hover:shadow-primary-500 flex justify-center items-center  rounded-full'>
